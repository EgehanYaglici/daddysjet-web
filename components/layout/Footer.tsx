...
const COL = [
  ["Keşfet", [["Hot Deals", "/search?hot=1"], ["Tüm Rotalar", "/search"], ["İstanbul → Bodrum", "/search?from=LTFM&to=LTFE"], ["İstanbul → Dubai", "/search?from=LTFM&to=OMDB"]]],
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 32px" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Türkiye&apos;nin ilk empty leg jet platformu. Yetkili operatörlerden boş bacak uçuşları,
              gerçek zamanlı fiyatlarla.
            </p>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                {links.map(([label, href]) => (
                  <Link
                    key={label}
                    href={href}
                    style={{ fontSize: 14, color: "rgba(255,255,255,.6)" }}
                  >
                    {label}
                  </Link>
                ))}
